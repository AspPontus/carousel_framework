 ...
 * @params: template, location, data, transitionTimeMs, intervalTimeMs, loop, infinite, buttons, BtnImageL, BtnImageR, AutoClickTag
 * 
 * All but the first three parameters are optional
 */
class Carousel {
